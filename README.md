...
Я не перевожу репозиторий в архив что бы списки не переставали генерироваться для тех кому необходимо. Если вам нужна помощь с чем либо, не пишите мне в телеграм, я не всезнайка, гугл в помощь, если же проблема с репозиторием то открывайты issue, прошу вас.
