...
Можете использовать VDS сервер от Timeweb Cloud, у них стабильно работают сервера и легко оплачивать.
Кто захочет, может использовать мою [рефералку.](https://timeweb.cloud/?i=129781) (Заранее спасибо)

Или же, если есть прослойка между интернетом и клиентом в виде сервера или производительного роутера рекомендую использовать [Zapret](https://github.com/bol-van/zapret), бесплатно, но морока.
