...
Eсли есть прослойка между интернетом и клиентом в виде домашнего сервера или производительного роутера рекомендую использовать [Zapret](https://github.com/bol-van/zapret), бесплатно, но морока с конфигами.
